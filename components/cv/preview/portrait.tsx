...
function SectionHeading({ children }: { children: React.ReactNode }) {
  return (
    <h2 className="mb-2 border-b border-amber-300 pb-1 text-[11px] font-bold tracking-[0.12em] text-amber-900 uppercase">
      {children}
    </h2>
  );
}

export function PortraitPreview({ data }: { data: CvData }) {
